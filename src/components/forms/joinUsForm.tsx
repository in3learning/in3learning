...
import { sgJoinUsFormAction } from '@/app/(app)/sg/actions'
...
export default function JoinUsForm() {
  ...
  useEffect(() => {
    if (pathname === '/us/join-us') {
      setCurrentCountry('us')
    } else if (pathname === '/sg/join-us') {
      setCurrentCountry('sg')
    }
  }, [])

  return (
    <form action={sgJoinUsFormAction} className='flex flex-col gap-4'>
